...
@24 = internal constant [31 x i8] c"*struct { chan int; chan bool }"
@25 = internal constant { i8*, i64 } { i8* getelementptr inbounds ([31 x i8], [31 x i8]* @24, i32 0, i32 0), i64 31 }
...
@26 = internal constant [41 x i8] c"*struct { chan int; chan int; chan bool }"
@27 = internal constant { i8*, i64 } { i8* getelementptr inbounds ([41 x i8], [41 x i8]* @26, i32 0, i32 0), i64 41 }
...
@30 = internal constant [9 x i8] c"chan bool"
@31 = internal constant { i8*, i64 } { i8* getelementptr inbounds ([9 x i8], [9 x i8]* @30, i32 0, i32 0), i64 9 }
@__go_tdn_bool = linkonce_odr constant %commonType { i8 -127, i8 1, i8 1, i64 1, i32 67110493, %funcVal* @__go_type_hash_identity_descriptor, %funcVal* @__go_type_equal_identity_descriptor, i8* bitcast ([2 x i8*]* @"__go_tdn_bool$gc" to i8*), { i8*, i64 }* @37, %uncommonType* @40, %commonType* null }
...
@32 = internal constant [8 x i8] c"chan int"
@33 = internal constant { i8*, i64 } { i8* getelementptr inbounds ([8 x i8], [8 x i8]* @32, i32 0, i32 0), i64 8 }
...
.0.entry:                                         ; preds = %prologue
  ...
  store i8* %9, i8** %15
  %16 = bitcast { i8*, i8* }* %13 to i8*
  call void @__go_go(i8* nest undef, i8* bitcast (void (i8*)* @41 to i8*), i8* %16)
  %17 = call i8* @__go_new(i8* nest undef, i8* getelementptr inbounds (%structType, %structType* @__go_td_S0_CN3_intsre0_CN3_intsre0_CN4_boolsree, i32 0, i32 0, i32 0), i64 24)
  %18 = bitcast i8* %17 to { i8*, i8*, i8* }*
  %19 = getelementptr inbounds { i8*, i8*, i8* }, { i8*, i8*, i8* }* %18, i32 0, i32 0
  store i8* %10, i8** %19
  %20 = getelementptr inbounds { i8*, i8*, i8* }, { i8*, i8*, i8* }* %18, i32 0, i32 1
  store i8* %11, i8** %20
  %21 = getelementptr inbounds { i8*, i8*, i8* }, { i8*, i8*, i8* }* %18, i32 0, i32 2
  store i8* %9, i8** %21
  %22 = bitcast { i8*, i8*, i8* }* %18 to i8*
  call void @__go_go(i8* nest undef, i8* bitcast (void (i8*)* @42 to i8*), i8* %22)
  %23 = call i8* @__go_new(i8* nest undef, i8* getelementptr inbounds (%structType, %structType* @__go_td_S0_CN3_intsre0_CN3_intsre0_CN4_boolsree, i32 0, i32 0, i32 0), i64 24)
  %24 = bitcast i8* %23 to { i8*, i8*, i8* }*
  %25 = getelementptr inbounds { i8*, i8*, i8* }, { i8*, i8*, i8* }* %24, i32 0, i32 0
  store i8* %10, i8** %25
  %26 = getelementptr inbounds { i8*, i8*, i8* }, { i8*, i8*, i8* }* %24, i32 0, i32 1
  store i8* %11, i8** %26
  %27 = getelementptr inbounds { i8*, i8*, i8* }, { i8*, i8*, i8* }* %24, i32 0, i32 2
  store i8* %9, i8** %27
  %28 = bitcast { i8*, i8*, i8* }* %24 to i8*
  call void @__go_go(i8* nest undef, i8* bitcast (void (i8*)* @43 to i8*), i8* %28)
  br label %.3.for.loop
...
.1.for.body:                                      ; preds = %.3.for.loop
  ...
  %varargs = bitcast i8* %31 to [1 x { i8*, i8* }]*
  %32 = bitcast [1 x { i8*, i8* }]* %varargs to i8*
  %33 = bitcast i8* %32 to { i8*, i8* }*
  %34 = getelementptr { i8*, i8* }, { i8*, i8* }* %33, i64 0
  %35 = bitcast { i8*, i8* }* %34 to i8*
  %36 = call i8* @__go_new(i8* nest undef, i8* getelementptr inbounds (%commonType, %commonType* @__go_tdn_int, i32 0, i32 0), i64 8)
  %37 = bitcast i8* %36 to i64*
  store i64 %30, i64* %37
  %38 = bitcast i64* %37 to i8*
  %39 = insertvalue { i8*, i8* } { i8* getelementptr inbounds (%commonType, %commonType* @__go_tdn_int, i32 0, i32 0), i8* undef }, i8* %38, 1
  ...
  store { i8*, i64, i64 } %44, { i8*, i64, i64 }* %2
  call void @fmt.Println({ i64, { i8*, i8* } }* sret %3, i8* nest undef, { i8*, i64, i64 }* byval %2)
  %45 = getelementptr inbounds { i64, { i8*, i8* } }, { i64, { i8*, i8* } }* %3, i32 0, i32 0
  %46 = load i64, i64* %45
  ...
  %varargs1 = bitcast i8* %51 to [1 x { i8*, i8* }]*
  %52 = bitcast [1 x { i8*, i8* }]* %varargs1 to i8*
  %53 = bitcast i8* %52 to { i8*, i8* }*
  %54 = getelementptr { i8*, i8* }, { i8*, i8* }* %53, i64 0
  %55 = bitcast { i8*, i8* }* %54 to i8*
  %56 = call i8* @__go_new(i8* nest undef, i8* getelementptr inbounds (%commonType, %commonType* @__go_tdn_int, i32 0, i32 0), i64 8)
  %57 = bitcast i8* %56 to i64*
  store i64 %50, i64* %57
  %58 = bitcast i64* %57 to i8*
  %59 = insertvalue { i8*, i8* } { i8* getelementptr inbounds (%commonType, %commonType* @__go_tdn_int, i32 0, i32 0), i8* undef }, i8* %58, 1
  %60 = bitcast i8* %55 to { i8*, i8* }*
  store { i8*, i8* } %59, { i8*, i8* }* %60
  %61 = getelementptr inbounds i8, i8* %52, i64 0
  %62 = insertvalue { i8*, i64, i64 } undef, i8* %61, 0
  %63 = insertvalue { i8*, i64, i64 } %62, i64 1, 1
  %64 = insertvalue { i8*, i64, i64 } %63, i64 1, 2
  store { i8*, i64, i64 } %64, { i8*, i64, i64 }* %5
  call void @fmt.Println({ i64, { i8*, i8* } }* sret %6, i8* nest undef, { i8*, i64, i64 }* byval %5)
  %65 = getelementptr inbounds { i64, { i8*, i8* } }, { i64, { i8*, i8* } }* %6, i32 0, i32 0
  %66 = load i64, i64* %65
  %67 = getelementptr inbounds { i64, { i8*, i8* } }, { i64, { i8*, i8* } }* %6, i32 0, i32 1
  %68 = load { i8*, i8* }, { i8*, i8* }* %67
  %69 = add i64 %i, 1
  br label %.3.for.loop
...
.3.for.loop:                                      ; preds = %.1.for.body, %.0.entry
  %i = phi i64 [ 0, %.0.entry ], [ %69, %.1.for.body ]
  %70 = icmp slt i64 %i, 5
  %71 = zext i1 %70 to i8
  %72 = trunc i8 %71 to i1
  br i1 %72, label %.1.for.body, label %.2.for.done
...
.6.for.loop:                                      ; preds = %.4.for.body, %.2.for.done
  %i2 = phi i64 [ 0, %.2.for.done ], [ %75, %.4.for.body ]
  %76 = icmp slt i64 %i2, 3
  %77 = zext i1 %76 to i8
  %78 = trunc i8 %77 to i1
  br i1 %78, label %.4.for.body, label %.5.for.done
}
