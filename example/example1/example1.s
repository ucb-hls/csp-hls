...
.0.entry:                                         ; preds = %prologue
  %5 = call i8* @__go_new_channel(i8* nest undef, i8* getelementptr inbounds (%chanType, %chanType* @__go_td_CN3_intsre, i32 0, i32 0, i32 0), i64 10)
...
.1.for.body:                                      ; preds = %.3.for.loop
  ...
  call void @__go_send_big(i8* nest undef, i8* getelementptr inbounds (%chanType, %chanType* @__go_td_CN3_intsre, i32 0, i32 0, i32 0), i8* %5, i8* %9)
  %10 = add i64 %i, 1
  br label %.3.for.loop

.2.for.done:                                      ; preds = %.3.for.loop
  %11 = call i8* @__go_new(i8* nest undef, i8* getelementptr inbounds (%structType, %structType* @__go_td_S0_CN3_intsre0_CN3_intsree, i32 0, i32 0, i32 0), i64 16)
  ...
  call void @__go_go(i8* nest undef, i8* bitcast (void (i8*)* @18 to i8*), i8* %15)
  %16 = call i8* @__go_new(i8* nest undef, i8* getelementptr inbounds (%structType, %structType* @__go_td_S0_CN3_intsre0_CN3_intsree, i32 0, i32 0, i32 0), i64 16)
  ...
  store i8* %7, i8** %19
  %20 = bitcast { i8*, i8* }* %17 to i8*
  call void @__go_go(i8* nest undef, i8* bitcast (void (i8*)* @19 to i8*), i8* %20)
  br label %.6.for.loop

.3.for.loop:                                      ; preds = %.1.for.body, %.0.entry
  %i = phi i64 [ 0, %.0.entry ], [ %10, %.1.for.body ]
  %21 = icmp slt i64 %i, 10
  %22 = zext i1 %21 to i8
...
.4.for.body:                                      ; preds = %.6.for.loop
  ...
  call void @__go_receive(i8* nest undef, i8* getelementptr inbounds (%chanType, %chanType* @__go_td_CN3_intsre, i32 0, i32 0, i32 0), i8* %7, i8* %24)
  %25 = load i64, i64* %2
  %26 = call i8* @__go_new(i8* nest undef, i8* getelementptr inbounds (%arrayType, %arrayType* @__go_td_AIe1e, i32 0, i32 0, i32 0), i64 16)
  %varargs = bitcast i8* %26 to [1 x { i8*, i8* }]*
  %27 = bitcast [1 x { i8*, i8* }]* %varargs to i8*
  %28 = bitcast i8* %27 to { i8*, i8* }*
  %29 = getelementptr { i8*, i8* }, { i8*, i8* }* %28, i64 0
  %30 = bitcast { i8*, i8* }* %29 to i8*
  %31 = call i8* @__go_new(i8* nest undef, i8* getelementptr inbounds (%commonType, %commonType* @__go_tdn_int, i32 0, i32 0), i64 8)
  %32 = bitcast i8* %31 to i64*
  store i64 %25, i64* %32
  %33 = bitcast i64* %32 to i8*
  %34 = insertvalue { i8*, i8* } { i8* getelementptr inbounds (%commonType, %commonType* @__go_tdn_int, i32 0, i32 0), i8* undef }, i8* %33, 1
  ...
  store { i8*, i64, i64 } %39, { i8*, i64, i64 }* %3
  call void @fmt.Println({ i64, { i8*, i8* } }* sret %4, i8* nest undef, { i8*, i64, i64 }* byval %3)
  %40 = getelementptr inbounds { i64, { i8*, i8* } }, { i64, { i8*, i8* } }* %4, i32 0, i32 0
  %41 = load i64, i64* %40
  %42 = getelementptr inbounds { i64, { i8*, i8* } }, { i64, { i8*, i8* } }* %4, i32 0, i32 1
...
.6.for.loop:                                      ; preds = %.4.for.body, %.2.for.done
  %i1 = phi i64 [ 0, %.2.for.done ], [ %44, %.4.for.body ]
  %45 = icmp slt i64 %i1, 10
  %46 = zext i1 %45 to i8
  %47 = trunc i8 %46 to i1
  br i1 %47, label %.4.for.body, label %.5.for.done
}
