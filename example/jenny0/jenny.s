...
.0.entry:                                         ; preds = %prologue
  %5 = call %FIFO* @fifo_malloc(i8 zeroext 64, i64 0)
  %6 = getelementptr inbounds { %FIFO* }, { %FIFO* }* %1, i32 0, i32 0
  store %FIFO* %5, %FIFO** %6
  %7 = bitcast { %FIFO* }* %1 to i8*
  store i32* %p, i32** %2
  %8 = bitcast i32*** %3 to i8**
  store i32** %2, i32*** %3
  %9 = load i8*, i8** %8
  call void @pthread_create(i8* %9, i8* null, i8* bitcast (i8* (i8*)* @auto_pthread_wrapper to i8*), i8* %7)
  %10 = call i64 @fifo_read(%FIFO* %5)
  store i64 %10, i64* %4
  %11 = load i64, i64* %4
  ret void
}
...
entry:                                            ; preds = %prologue
  call void @main.process(i8* nest undef, %FIFO* %3)
  ret void
}

define internal void @main.process(i8* nest, %FIFO*) #0 {
prologue:
  br label %.0.entry

.0.entry:                                         ; preds = %prologue
  call void @fifo_write(%FIFO* %1, i64 7)
  ret void
}
