...
void main_OC_main(uint8_t* llvm_cbe_tmp__4) {
  ...
  *(((uint64_t*)(((uint8_t*)((&(((uint64_t*)llvm_cbe_tmp__10))[((int64_t)UINT64_C(5))])))))) = UINT64_C(0);
  ...
  llvm_cbe_tmp__11.field0 = 0;
  llvm_cbe_tmp__12 = llvm_cbe_tmp__11;
  llvm_cbe_tmp__12.field1 = UINT64_C(3);
  llvm_cbe_tmp__13 = llvm_cbe_tmp__12;
  llvm_cbe_tmp__13.field2 = UINT64_C(3);
  data1.llvm_cbe_tmp__62 = &llvm_cbe_tmp__11;

  llvm_cbe_tmp__11 = llvm_ctor_unnamed_1(((uint8_t*)/*NULL*/0), UINT64_C(0), UINT64_C(0));
  //llvm_cbe_tmp__11.field0 = ((&(*llvm_cbe_tmp__10)));
  llvm_cbe_tmp__11.field0 = 3;
  llvm_cbe_tmp__12 = llvm_cbe_tmp__11;
  llvm_cbe_tmp__12.field1 = UINT64_C(3);
  llvm_cbe_tmp__13 = llvm_cbe_tmp__12;
  llvm_cbe_tmp__13.field2 = UINT64_C(3);
  data2.llvm_cbe_tmp__62 = &llvm_cbe_tmp__11;
  ...
  FIFO *llvm_cbe_tmp__14 = fifo_malloc(/*data_width =*/ 32, /*fifo_depth =*/10);
  data1.llvm_cbe_tmp__63 = llvm_cbe_tmp__14; 
  data2.llvm_cbe_tmp__63 = llvm_cbe_tmp__14; 


  llvm_cbe_tmp__15 = llvm_sgtgtdiv_u64(((llvm_cbe_tmp__13.field1)), UINT64_C(2));
...
struct thread_data {
    int s_index;
    FIFO * llvm_cbe_tmp__63;
    struct l_unnamed_l * llvm_cbe_tmp__62;
};

int s[6] = {7, 2, 8, -9, 4, 0};
static void main_OC_sum(void* args) {
//static void main_OC_sum(uint8_t* llvm_cbe_tmp__61, struct l_unnamed_1 llvm_cbe_tmp__62, uint8_t* llvm_cbe_tmp__63) {
llvm_cbe_tmp__65 = data->llvm_cbe_tmp__62;
  ...
  //llvm_cbe_tmp__67__PHI_TEMPORARY = UINT64_C(0);   /* for PHI node */
...
llvm_cbe__2e_2_2e_rangeindex_2e_body:
  ...
  llvm_cbe_tmp__69 = &s[llvm_cbe_tmp__65.field0];
...
llvm_cbe_tmp__73:
  ...
  llvm_cbe_tmp__70 = llvm_cbe_tmp__69[llvm_cbe_tmp__68];
...
llvm_cbe__2e_3_2e_rangeindex_2e_done:
  ...
  fifo_write((FIFO*)data -> llvm_cbe_tmp__63, llvm_cbe_tmp__64);
