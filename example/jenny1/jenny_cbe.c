...
// JENNY for first parameter of 'main' (argument count) must be of type 'int'
//LegUp expects main() to have no function arguments
int main() {
...
//void main(uint8_t* llvm_cbe_tmp__4) {
  ...
  llvm_cbe_tmp__14 = fifo_malloc(64u, UINT64_C(1));
