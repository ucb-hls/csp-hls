...
typedef void l_fptr_1(uint8_t*, FIFO*);
...
static void main_OC_main_KD_main_OC_main_EC_1(uint8_t*, FIFO*);
...
void main_OC_main(uint8_t* llvm_cbe_tmp__4) {
  ...
  llvm_cbe_tmp__11 = ((uint8_t*)(&llvm_cbe_a));
  *(((uint64_t*)llvm_cbe_tmp__11)) = UINT64_C(19);
  *((&llvm_cbe_tmp__5.field0)) = ((uint8_t*)main_OC_main_KD_main_OC_main_EC_1);
  *((&llvm_cbe_tmp__5.field1)) = llvm_cbe_tmp__11;
  *((&llvm_cbe_tmp__6.field0)) = (((uint8_t*)(&llvm_cbe_tmp__5)));
  *((&llvm_cbe_tmp__6.field1)) = llvm_cbe_tmp__10;
  llvm_cbe_tmp__7 = (&llvm_cbe_thread_id);
  llvm_cbe_tmp__8 = (&llvm_cbe_tmp__7);
  llvm_cbe_tmp__12 = *(((uint8_t**)(&llvm_cbe_tmp__8)));
  pthread_create(llvm_cbe_tmp__12, ((uint8_t*)/*NULL*/0), ((uint8_t*)auto_pthread_wrapper), (((uint8_t*)(&llvm_cbe_tmp__6))));
  llvm_cbe_tmp__13 = fifo_read(llvm_cbe_tmp__10);
  llvm_cbe_tmp__9 = llvm_cbe_tmp__13;
  llvm_cbe_tmp__14 = llvm_cbe_tmp__9;
}


static void main_OC_main_KD_main_OC_main_EC_1(uint8_t* llvm_cbe_tmp__15, FIFO* llvm_cbe_someChan) {
  uint8_t* llvm_cbe_tmp__16;
  uint64_t llvm_cbe_tmp__17;

  llvm_cbe_tmp__16 = *((&(((struct l_unnamed_1*)llvm_cbe_tmp__15))->field1));
  llvm_cbe_tmp__17 = *(((uint64_t*)llvm_cbe_tmp__16));
  fifo_write(llvm_cbe_someChan, llvm_cbe_tmp__17);
}
...
static void tmp__18(uint8_t* llvm_cbe_tmp__19) {
  ...
  llvm_cbe_tmp__20 = ((struct l_unnamed_2*)llvm_cbe_tmp__19);
  llvm_cbe_tmp__21 = *((&llvm_cbe_tmp__20->field0));
  llvm_cbe_tmp__22 = *((&llvm_cbe_tmp__20->field1));
  llvm_cbe_tmp__23 = *(((uint8_t**)llvm_cbe_tmp__21));
  (((l_fptr_1*)llvm_cbe_tmp__23))(llvm_cbe_tmp__21, llvm_cbe_tmp__22);
}


static uint8_t* auto_pthread_wrapper(uint8_t* llvm_cbe_tmp__24) {
  tmp__18(llvm_cbe_tmp__24);
